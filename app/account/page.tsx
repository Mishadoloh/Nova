...
export default function AccountPage() {
  ...
  const exportData = () => { const blob = new Blob([JSON.stringify(data,null,2)],{type:"application/json"}); const link=document.createElement("a"); link.href=URL.createObjectURL(blob); link.download="nova-backup.json"; link.click(); URL.revokeObjectURL(link.href); };
  return <AppFrame active="account">
    <PageTitle eyebrow="Твій простір" title="Профіль і синхронізація" description="NOVA пам’ятає твій ритм на всіх пристроях." />
